...
class ICoreStream // can't name it IStream cause it conflicts with COM stuff (angry face)
{
public:
    virtual ~ICoreStream() {}
...
class IInStream : public ICoreStream
{
public:
...
class IOutStream : public ICoreStream
{
public:
