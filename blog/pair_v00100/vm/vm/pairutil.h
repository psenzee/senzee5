...
public:
    ...
    inline bool    hasnext() { return iter != 0; }
    inline Object *next()    { Object *u = iter->head, *t = iter->tail; iter = t ? t->cast_pair() : 0; return u; }

    inline bool      operator==(const PairIter &i) const { return iter == i.iter; }
    inline bool      operator!=(const PairIter &i) const { return iter != i.iter; }
    inline PairIter &operator++()                        { next(); return *this; }
...
public:
    ...
    static IOutStream          &print(IOutStream &os, const Object *e);
    static Object              *remove(Pair *e, unsigned i);
