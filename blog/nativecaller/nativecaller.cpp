...
// the Types (types.h) class provides static boxing/unboxing functions such as:
//
// unboxing functions:
//
//  float       Types::to_float(Object *);
//  unsigned    Types::to_uint(Object *);
//  const char *Types::to_cstr(Object *);
//  void       *Types::to_pointer(Object *);
//  etc..
//
// boxing functions:
// 
//  Object *Types::create_float(float);
//  Object *Types::create_uint(unsigned);
//  Object *Types::create_string(unsigned);
//  etc..
...
Object *NativeCaller::m_call_pointer(const unsigned char *code, const Converters &converters, void *function, Object **array)
{
    ...
    return Types::create_raw_pointer(fn(converters, function, array));
}
